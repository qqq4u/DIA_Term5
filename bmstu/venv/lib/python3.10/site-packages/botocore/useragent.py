...
class UserAgentString:
    ...
    def _build_app_id(self):
        """
        Build bmstu component of the User-Agent header string.

        Returns a single component with prefix "bmstu" and value sourced from the
        ...
        if self._client_config and self._client_config.user_agent_appid:
            return [
                UserAgentComponent('bmstu', self._client_config.user_agent_appid)
            ]
        else:
            return []
